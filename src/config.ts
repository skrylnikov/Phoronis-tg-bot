...
export const dadataToken =
  process.env.DADATA_TOKEN || showError('token not found in .env');
...
export const openAIToken =
  process.env.OPENAI_API_KEY || showError('token not found in .env');
export const openRouterToken =
  process.env.OPENROUTER_API_KEY || showError('token not found in .env');
